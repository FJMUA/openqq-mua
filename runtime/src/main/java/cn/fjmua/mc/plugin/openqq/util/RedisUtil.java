...
public class RedisUtil {
    ...
    static {
        ...
        if (jedisPool == null) {
            ...
            config.setTestOnBorrow(Boolean.parseBoolean(bundle.getString("redis.pool.testOnBorrow").trim()));
            config.setTestOnReturn(Boolean.parseBoolean(bundle.getString("redis.pool.testOnReturn").trim()));
    ...
    public static class SortSet {
        ...
        public long zlength(String key) {
            long len = 0;
            List<String> set = zrange(key, 0, -1);
            len = set.size();
            return len;
        }
        ...
        public List<String> zrange(String key, int start, int end) {
            Jedis sjedis = getJedis();
            List<String> set = sjedis.zrange(key, start, end);
            returnJedis(sjedis);
            return set;
        }
        ...
        public List<String> zrangeByScore(String key, double min, double max) {
            Jedis sjedis = getJedis();
            List<String> set = sjedis.zrangeByScore(key, min, max);
            returnJedis(sjedis);
            return set;
        }
        ...
        public List<String> zrevrange(String key, int start, int end) {
            //ShardedJedis sjedis = getShardedJedis();
            Jedis sjedis = getJedis();
            List<String> set = sjedis.zrevrange(key, start, end);
            returnJedis(sjedis);
            return set;
        }
